			...
			<div className='hotelForm'>
				...
				>
					...
					<div>
						...
						<div
							style={{ fontSize: '.9rem', marginBottom: '1rem' }}
						>
							...
							<input
								...
								onChange={(e) =>
									this.setState({ operatingHours: true })
								}
							/>{' '}
							Yes
							<br />
							<input
								...
								value={this.state.operatingHours}
								onChange={(e) =>
									this.setState({ operatingHours: false })
								}
							/>{' '}
							No
						</div>
